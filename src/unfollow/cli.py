...
from src.unfollow.config import get_config
...
def end(follower_num=0): ## remember TO CHANge THIS
    ...
    if panels:
        ...
        print("")
        txt_b = Panel.fit(f"You have {follower_num} followers. Keep up the good work\
\n", subtitle="Thanks for using this project", subtitle_align="left")
        console.print(txt_b)
        print("\n")
    elif not panels:
        print("")
...
def start():
    if panels:
        ...
        print("")
        txt = "Welcome to who-unfollowed-me Python implementation by Zac the Wise"
    elif not panels:
        print("")
